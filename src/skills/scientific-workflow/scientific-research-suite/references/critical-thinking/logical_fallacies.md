...
**Related:** *Cum hoc ergo propter hoc* (with this, therefore because of this) - correlation mistaken for causation even
...
- "Depression is associated with inflammation, so inflammation causes depression." (Could be: depression causes
  inflammation)
...
**Why fallacious:** Anecdotes are unreliable due to selection bias, memory bias, and confounding. Plural of anecdote ≠
data.
...
- "The probability of this DNA match occurring by chance is 1 in 1 million, so there's only a 1 in 1 million chance the
