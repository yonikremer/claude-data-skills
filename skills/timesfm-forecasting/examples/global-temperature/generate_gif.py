...
def create_frame(
    ...
    Args:
        ...
        step_data: Data for the current animation step.
        actual_data: The full historical actual data.
        final_forecast: The data for the final forecast step (for background).
        total_steps: Total number of steps in the animation.
...
def main() -> None:
    """Run the animated GIF generation process."""
    print("=" * 60)
    ...
    all_values_for_axis = np.concatenate(
        [
            all_actual_values,
    ...
    y_min = all_values_for_axis.min() - 0.05
    y_max = all_values_for_axis.max() + 0.05
