...
def detect_file_type(filepath: Union[str, Path]) -> Tuple[str, str, str]:
    """
    ...
    Returns:
        A tuple containing (extension, file_category, reference_description).
    """
...
def get_file_basic_info(filepath: Union[str, Path]) -> Dict[str, Any]:
    """
    ...
    Returns:
        A dictionary containing basic file information.
    """
    file_path = Path(filepath)
    stat = file_path.stat()
...
def load_reference_info(category: str, extension: str) -> Optional[Dict[str, str]]:
    """
    ...
    Returns:
        Reference information dictionary or None if not found.
    """
...
def analyze_file(filepath: Union[str, Path]) -> Dict[str, Any]:
    """
...
def analyze_general_scientific(
    ...
    if extension in ["npy"]:
        ...
        with h5py.File(filepath, "r") as f:
            ...
            def get_structure(group: Any, prefix: str = "") -> Dict[str, Any]:
                items = {}
...
def analyze_imaging(filepath: Union[str, Path], extension: str) -> Dict[str, Any]:
    """
