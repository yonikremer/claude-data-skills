...
description: Guided statistical analysis with test selection and reporting. Use when needing help choosing appropriate tests and generating APA-formatted results. Do NOT use for implementing specific models (use statsmodels) or for business metric analysis (use statistical-analysis-business).
---
