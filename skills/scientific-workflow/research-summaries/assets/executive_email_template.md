# Insight: [Single most impactful sentence from the research]

**Summary**: We investigated [Problem] and found that [Key Insight]. This suggests we should [Primary Action].
