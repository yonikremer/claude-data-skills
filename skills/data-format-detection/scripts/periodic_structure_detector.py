...
def find_bitwise_periodicity(data, max_bit_period=None):
    """
    Find the most likely bit-period by calculating average 
    absolute difference between bit-frames.
    """
...
def main():
    ...
    print(f"Analyzing {path.name} ({len(data)} bytes) for bitwise periodic structures...")
